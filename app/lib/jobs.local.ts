...
import { Approach, Assignments, Profession, DCStatus, WorkingPattern, WorkLocation } from "./jobTypes";
...
{ approach: Approach.Internal,
  ...
  workingPattern: WorkingPattern.FullTime,
...
{ approach: Approach.AcrossGovernment,
  ...
  disabilityConfident: DCStatus.Leader,
...
{ approach: Approach.External, 
  ...
  grade: 'Grade 6', 
  profession: Profession.Communications,
  description: 'This is a fantastic job for a ...', 
  location: [{
    saoText: undefined,
...
{ approach: Approach.External, 
  ...
  profession: Profession.ProjectDelivery,
  description: 'This is a fantastic job for a ...', 
  location: [{
    saoText: undefined,
    paoText: '2 Horse Guards',
...
{ approach: Approach.External, 
  ...
  applyDetail: 'Some application detail text',
  recruitmentEmail: 'recruitment@civilservice.gov.uk',
  assignmentType: Assignments.Apprentice, 
  workingPattern: WorkingPattern.FullTime,
  workLocation: [WorkLocation.Office],
  grade: 'Higher Executive Office', 
  profession: Profession.Clinical,
  description: 'This is a fantastic job for a ...', 
  location: [{
    saoText: undefined,
    paoText: undefined,
...
{ approach: Approach.External,
  ...
  grade: 'Grade 7',
  jobNumbers: 1,
  profession: Profession.InternationalTrade,
...
{ approach: Approach.External,
  ...
  grade: 'SEO',
  jobNumbers: 1,
  profession: Profession.Planning,
